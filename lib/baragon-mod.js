...
function createRestfulData(options) {
    var restdata = {};
//    if (options.message) {
          restdata = {"update" : {"comment": [ { "add": { "body" : "took place here c960151767abfe000e007278d59a70512861fb01 ancient history, closing" } }] }};
//        restdata.update.comment.add.body = options.message.toString();
//    }
//    restdata.assignee = {"name" : "lorinbeer" };
//    restdata.resolution = {"id" : "1"};
    restdata.transition = {"id" : "2"};
